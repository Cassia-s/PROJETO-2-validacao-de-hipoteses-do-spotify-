...
-- 📌 Tratamento de Colunas Técnicas
SELECT 
  track_id,
...
-- 📌 Criação de release_date e total_por_charts_playlists 
SELECT *,
...
-- 📌 Criar uma nova tabela com as variaveis e classificações
SELECT
  t.track_id,
  t.track_name,
  t.artist_s__name,
